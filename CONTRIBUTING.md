...
./service-ca-operator-tests-ext run-suite "openshift/service-ca-operator/operator/parallel"
./service-ca-operator-tests-ext run-test "test-name"

# Run with JUnit output
./service-ca-operator-tests-ext run-suite openshift/service-ca-operator/operator/parallel --junit-path /tmp/junit.xml

# Run all test suites sequentially
./service-ca-operator-tests-ext run-suite "openshift/service-ca-operator/operator/parallel"
./service-ca-operator-tests-ext run-suite "openshift/service-ca-operator/operator/serial"
./service-ca-operator-tests-ext run-suite "openshift/service-ca-operator/operator/serial-disruptive"
```
...
./service-ca-operator-tests-ext list tests --suite=openshift/service-ca-operator/operator/parallel
```
