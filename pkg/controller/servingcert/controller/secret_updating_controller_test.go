		...
		},
		{
			...
			secret: &v1.Secret{
				ObjectMeta: metav1.ObjectMeta{
					...
					OwnerReferences: []metav1.OwnerReference{serviceOwnerRef(&v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "foo", UID: types.UID("uid-2")}})},
				},
			},
			expected:       false,
			serviceIsValid: false,
		},
		{
			...
			secret: &v1.Secret{
				ObjectMeta: metav1.ObjectMeta{
					...
					OwnerReferences: []metav1.OwnerReference{serviceOwnerRef(&v1.Service{ObjectMeta: metav1.ObjectMeta{Name: "foo", UID: types.UID("uid-1")}})},
				},
			},
			expected:       false,
			serviceIsValid: false,
