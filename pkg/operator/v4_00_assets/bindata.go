...
var _bintree = &bintree{nil, map[string]*bintree{
	"v4.0.0": {nil, map[string]*bintree{
		"apiservice-cabundle-controller": {nil, map[string]*bintree{
			...
			"rolebinding.yaml":        {v400ApiserviceCabundleControllerRolebindingYaml, map[string]*bintree{}},
			"sa.yaml":                 {v400ApiserviceCabundleControllerSaYaml, map[string]*bintree{}},
			"signing-cabundle.yaml":   {v400ApiserviceCabundleControllerSigningCabundleYaml, map[string]*bintree{}},
		}},
		"configmap-cabundle-controller": {nil, map[string]*bintree{
			...
			"rolebinding.yaml":        {v400ConfigmapCabundleControllerRolebindingYaml, map[string]*bintree{}},
			"sa.yaml":                 {v400ConfigmapCabundleControllerSaYaml, map[string]*bintree{}},
			"signing-cabundle.yaml":   {v400ConfigmapCabundleControllerSigningCabundleYaml, map[string]*bintree{}},
		}},
