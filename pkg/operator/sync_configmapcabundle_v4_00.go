...
func syncConfigMapCABundleController_v4_00_to_latest(c serviceCertSignerOperator, operatorConfig *scsv1.ServiceCA) error {
	var err error
...
func manageConfigMapCABundleDeployment_v4_00_to_latest(client appsclientv1.AppsV1Interface, eventRecorder events.Recorder, options *scsv1.ServiceCA, forceDeployment bool) (*appsv1.Deployment, bool, error) {
	...
	return resourceapply.ApplyDeployment(client, eventRecorder, required, getGeneration(client, targetNamespaceName, required.Name), forceDeployment)
}
