...
import (
	...
	// The import below is necessary to ensure that the service-ca operator tests are registered with the extension.
	_ "github.com/openshift/service-ca-operator/test/tests-extension/test"
)

func main() {
	registry := e.NewRegistry()
	ext := e.NewExtension("openshift", "payload", "service-ca-operator")
	...
	ext.AddSuite(e.Suite{
		Name:    "openshift/service-ca-operator/conformance/serial",
	...
	ext.AddSuite(e.Suite{
		Name:    "openshift/service-ca-operator/optional/slow",
	...
	ext.AddSuite(e.Suite{
		Name: "openshift/service-ca-operator/all",
	})
